 ...
 */
export const arpLookupMutation = (
  options?: Partial<Options<ArpLookupData>>,
): UseMutationOptions<
  ArpLookupResponse2,
  ArpLookupError,
  Options<ArpLookupData>
> => {
...
export const exportDevicesQueryKey = (options?: Options<ExportDevicesData>) =>
  createQueryKey("exportDevices", options);
 ...
 */
export const exportDevicesOptions = (options?: Options<ExportDevicesData>) =>
  queryOptions<
    ExportDevicesResponse,
    ExportDevicesError,
    ExportDevicesResponse,
    ReturnType<typeof exportDevicesQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const importDevicesMutation = (
  options?: Partial<Options<ImportDevicesData>>,
): UseMutationOptions<
  ImportDevicesResponse,
  ImportDevicesError,
  Options<ImportDevicesData>
> => {
  const mutationOptions: UseMutationOptions<
    ImportDevicesResponse,
    ImportDevicesError,
 ...
 */
export const wakeDeviceMutation = (
  options?: Partial<Options<WakeDeviceData>>,
): UseMutationOptions<
  WakeDeviceResponse,
  WakeDeviceError,
  Options<WakeDeviceData>
> => {
  const mutationOptions: UseMutationOptions<
    WakeDeviceResponse,
    WakeDeviceError,
